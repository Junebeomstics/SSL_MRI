...
최종 코드 실행 예시는 아래와 같습니다. 각 arguement에 대한 설명은 `main.cv` 파일을 참고해주세요.
...
최종 5-fold stratified cross-validation 코드 실행 예시는 아래와 같습니다. 각 arguement에 대한 설명은 `main.cv` 파일을 참고해주세요.
```bash
...
| **1. AD vs CN (N=100)** | FromScratch | BHByAa64c | UKBsim32a | UKByAa32a | UKBsim64a | UKByAa64a | 
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| (tune)   | 0.83 +/- 0.03 | 0.83 +/- 0.03 | 0.84 +/- 0.02 | 0.84 +/- 0.01 | 0.84 +/- 0.01 | 0.83 +/- 0.02 |
| (freeze) | 0.70 +/- 0.01 | 0.72 +/- 0.00 | 0.71 +/- 0.01 | 0.70 +/- 0.01 | 0.71 +/- 0.00 | 0.72 +/- 0.00 |
| **2. AD vs CN (N=300)** |  |  |  |  |  |  |
| (tune)   | 0.90 +/- 0.00 | 0.90 +/- 0.01 | 0.90 +/- 0.02 | 0.91 +/- 0.01 | 0.91 +/- 0.01 | 0.90 +/- 0.01 |
| (freeze) | 0.75 +/- 0.01 | 0.75 +/- 0.02 | 0.75 +/- 0.02 | 0.75 +/- 0.02 | 0.76 +/- 0.02 | 0.75 +/- 0.02 |
| **3. AD vs MCI (N=100)** |  |  |  |  |  |  |
| (tune)   | 0.70 +/- 0.03 | 0.68 +/- 0.02 | 0.69 +/- 0.03 | 0.69 +/- 0.01 | 0.66 +/- 0.04 | 0.68 +/- 0.03 |
| (freeze) | 0.65 +/- 0.03 | 0.66 +/- 0.02 | 0.65 +/- 0.03 | 0.65 +/- 0.03 | 0.60 +/- 0.13 | 0.65 +/- 0.03 |
| **4. AD vs MCI (N=300)** |  |  |  |  |  |  |
| (tune)   | 0.74 +/- 0.03 | 0.77 +/- 0.01 | 0.76 +/- 0.02 | 0.76 +/- 0.02 | 0.75 +/- 0.04 | 0.75 +/- 0.02 |
| (freeze) | 0.66 +/- 0.01 | 0.66 +/- 0.02 | 0.67 +/- 0.02 | 0.68 +/- 0.01 | 0.67 +/- 0.01 | 0.67 +/- 0.02 |
| **5. MCI vs CN (N=100)** |  |  |  |  |  |  |
| (tune)   | 0.58 +/- 0.02 | 0.59 +/- 0.01 | 0.58 +/- 0.00 | 0.59 +/- 0.01 | 0.59 +/- 0.01 | 0.60 +/- 0.01 |
| (freeze) | 0.55 +/- 0.04 | 0.55 +/- 0.04 | 0.56 +/- 0.03 | 0.54 +/- 0.05 | 0.57 +/- 0.01 | 0.57 +/- 0.01 |
| **6. MCI vs CN (N=500)** |  |  |  |  |  |  |
| (tune)   | 0.60 +/- 0.01 | 0.59 +/- 0.05 | 0.59 +/- 0.02 | 0.61 +/- 0.01 | 0.60 +/- 0.01 | 0.59 +/- 0.02 |
| (freeze) | 0.57 +/- 0.03 | 0.58 +/- 0.03 | 0.57 +/- 0.05 | 0.59 +/- 0.01 | 0.58 +/- 0.02 | 0.59 +/- 0.02 |

| **1. AD vs CN (N=100)** | UKBsim64c | UKByAa64cS05 | UKByAa64cS15 | UKBsimplusyAa64c |
| :---: | :---: | :---: | :---: | :---: |
| (tune)   | 0.85 +/- 0.01 | 0.84 +/- 0.02 | 0.82 +/- 0.04 | 0.84 +/- 0.02 |
| (freeze) | 0.71 +/- 0.01 | 0.71 +/- 0.01 | 0.71 +/- 0.01 | 0.72 +/- 0.00 |
| **2. AD vs CN (N=300)** |  |  |  |  |
| (tune)   | 0.90 +/- 0.01 | 0.89 +/- 0.01 | 0.90 +/- 0.01 | 0.89 +/- 0.01 |
| (freeze) | 0.75 +/- 0.02 | 0.75 +/- 0.02 | 0.75 +/- 0.02 | 0.75 +/- 0.02 |
| **3. AD vs MCI (N=100)** |  |  |  |  |
| (tune)   | 0.70 +/- 0.02 | 0.68 +/- 0.02 | 0.68 +/- 0.01 | 0.69 +/- 0.03 |
| (freeze) | 0.65 +/- 0.03 | 0.64 +/- 0.05 | 0.63 +/- 0.08 | 0.62 +/- 0.09 |
| **4. AD vs MCI (N=300)** |  |  |  |  |
| (tune)   | 0.76 +/- 0.02 | 0.77 +/- 0.02 | 0.78 +/- 0.01 | 0.76 +/- 0.01 |
| (freeze) | 0.67 +/- 0.01 | 0.67 +/- 0.01 | 0.68 +/- 0.01 | 0.68 +/- 0.02 |
| **5. MCI vs CN (N=100)** |  |  |  |  |
| (tune)   | 0.58 +/- 0.02 | 0.58 +/- 0.03 | 0.59 +/- 0.01 | 0.59 +/- 0.01 | 0.58 +/- 0.01 |
| (freeze) | 0.57 +/- 0.00 | 0.56 +/- 0.03 | 0.55 +/- 0.04 | 0.55 +/- 0.04 | 0.57 +/- 0.01 |
| **6. MCI vs CN (N=500)** |  |  |  |  |
| (tune)   | 0.59 +/- 0.04 | 0.59 +/- 0.02 | 0.60 +/- 0.01 | 0.60 +/- 0.01 |
| (freeze) | 0.56 +/- 0.05 | 0.58 +/- 0.01 | 0.58 +/- 0.02 | 0.57 +/- 0.02 |
